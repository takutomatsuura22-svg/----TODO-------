-- ============================================
-- テスト用志望校マスタデータ（RLSバイパス版）
-- ============================================
-- このSQLをSupabase SQL Editorで実行して、テスト用の志望校マスタを作成します
-- RLSを一時的に無効化して実行します

-- RLSを一時的に無効化
ALTER TABLE public.admission_programs DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.admission_schedules DISABLE ROW LEVEL SECURITY;
